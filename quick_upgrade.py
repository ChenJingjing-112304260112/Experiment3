...
# 训练模型
print('训练中...')
model.fit(X_train, y_train, batch_size=64, epochs=8, validation_split=0.2, verbose=1)
...
submission.to_csv('quick_upgrade_submission.csv', index=False)

print('完成！提交文件: quick_upgrade_submission.csv')