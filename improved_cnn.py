...
print('模型已保存为 improved_model.h5')
...
plt.tight_layout()
plt.savefig('improved_loss_curve.png', dpi=300, bbox_inches='tight')
print('训练曲线已保存为 improved_loss_curve.png')
...
print('提交文件已生成: improved_submission.csv')
print('Done!')